...
public class Falcon9Tester {
	...
	public static void main(String[] args) {
		...
		Falcon9 rocket = new Falcon9(300, 300, 40, 40);
		...
		while (rocket.getDeltaTime() <= rocket.getBurnTime()) {
			System.out.println(rocket.getDeltaTime() + "," + rocket.getMass() + "," + rocket.getNetForce() + "," + rocket.getAcceleration() + "," + rocket.getVelocity() + "," + rocket.getAltitude());
			//System.out.println(rocket.getDeltaTime() + ", " + rocket.getDrag());
			rocket.move(0.5);
		}
